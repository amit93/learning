...
public class SimpleItemItemModel implements Serializable
{
	 ...
	 * 
	 * @param nbrhoods A mapping of items to neighborhoods. The neighborhoods must be sorted by similarity in
	 *        non-increasing order (most similar neighbors first). They should not have any negative scores.
	 */
